<div class="row">
  <form class="col-lg-3" method="POST" role="form">
    ...
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-plus-square-o fa-fw"></i> 採掘アカウントの追加
      </div>
      ...
      <div class="panel-footer">
        <input type="submit" value="作成" class="btn btn-success btn-sm">
      </div>
    </div>
  </form>
  ...
  <div class="col-lg-9">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-gears fa-fw"></i> 採掘アカウントの設定
      </div>
      <form action="{$smarty.server.SCRIPT_NAME}" method="post" role="form">
        ...
        <div class="panel-body no-padding">
          ...
          <table class="table">
             <thead>
                <tr>
                  <th class="smallwidth">ワーカー名</th>
                  <th class="smallwidth">パスワード</th>
                  <th class="text-center">ステータス</th>
                  {if $GLOBAL.config.disable_notifications != 1 && $DISABLE_IDLEWORKERNOTIFICATIONS != 1}<th class="text-center">監視</th>{/if}
                  <th class="text-right">Khash/s</th>
                  <th class="text-right">作業量</th>
          ...
          <div class="panel-footer">
            <input type="submit" class="btn btn-success btn-sm" value="採掘アカウントの更新">
          </div>
        </div>
      </form>
    </div>
