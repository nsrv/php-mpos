  ...
  <div class="col-lg-12">
    <div class="panel panel-info">
      <div class="panel-heading">
        <i class="fa fa-refresh fa-fw"></i> ラウンドの統計
      </div>
...
{assign var=percentage2 value=0}
              ...
              <tr class="even">
                ...
                <td>{if $BLOCKDETAILS.confirmations >= $GLOBAL.confirmations}
                  <font color="green">検証済み</font>
                {else if $BLOCKDETAILS.confirmations == -1}
                  <font color="red">無効</font>
                {else if $BLOCKDETAILS.confirmations == 0}0
                {else}<font color="orange">検証中</font>（残り{($GLOBAL.confirmations - $BLOCKDETAILS.confirmations)|default:"0"}ブロック）{/if}</td>
                <td>ブロック平均</td>
              ...
              <ul class="pager">
                <form action="{$smarty.server.SCRIPT_NAME}" method="POST" id='search' role="form">
                  ...
                  <div class="input-group input-group-sm">
                    <span class="input-group-addon">ブロック番号を検索</span>
