      <table class="table borderless m-b-none text-small panel-footer">
        <thead>
          <tr>
            <th></th>
            <th><span><h5><i class="fa fa-user fa-fw"></i> 自分</h5></span></th>
            <th><span><h5><i class="fa fa-users fa-fw"></i> プール全体</h5></span></th>
          </tr>
          <tr>
            <th><h5><i class="fa fa-smile-o fa-fw"></i> 有効</h5></th>
            <th>
          ...
          <tr>
            <th><h5><i class="fa fa-frown-o fa-fw"></i> 無効</h5></th>
            <th>
            <div class="progress progress-striped progress-fix">
          ...
          <tr>
            <th><h5><i class="fa fa-bolt fa-fw"></i> 採掘効率</h5></th>
            <th>
